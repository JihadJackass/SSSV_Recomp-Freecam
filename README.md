...
- Configurable in-game (no rebuilds): recenter delay, "never recenter" mode,
...
|---|---|---|---|
| Recenter delay (seconds) | 0–30 | 3 | How long after releasing MMB before the camera starts drifting back behind your animal. 0 ≈ vanilla behavior. |
...
to the configured delay — so everything downstream (smoothing, wall
avoidance, the eventual return-to-heading) is stock game logic.
...
- [mkst](https://github.com/mkst/sssv) and the SSSV decompilation
  contributors — the camera reverse engineering that made this mod's
  precision possible
- [Cellenseres](https://github.com/Cellenseres/SSSV_Recomp) — the SSSV
  Recompiled port and its symbol files
- [Mr-Wiseguy and the N64Recomp project](https://github.com/N64Recomp/N64Recomp) —
  the recompilation and modding toolchain
